package com.dxc.notificationservice.infrastructure.adapter.in.rest;

import com.dxc.notificationservice.domain.exception.BusinessRuleException;
import com.dxc.notificationservice.domain.exception.DomainException;
import com.dxc.notificationservice.domain.exception.RecordNotFoundException;
import com.dxc.notificationservice.infrastructure.adapter.in.rest.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBusinessRule(BusinessRuleException ex) {
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ErrorResponse.of("BUSINESS_RULE_ERROR", ex.getMessage(), null));
    }
    ...
    public ResponseEntity<ErrorResponse> handleDomain(DomainException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorResponse.of("DOMAIN_ERROR", ex.getMessage(), null));
    }
