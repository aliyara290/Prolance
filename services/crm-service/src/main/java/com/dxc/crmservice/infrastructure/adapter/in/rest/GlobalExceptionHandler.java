...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleServiceLogic(ServiceLogicException ex) {
        log.warn("Service logic error: {}", ex.getMessage());
        return ResponseEntity.badRequest()
                .body(ErrorResponse.of("SERVICE_LOGIC_ERROR", ex.getMessage(), null));
    }
